...
[![](https://goreportcard.com/badge/github.com/weblazy/builder)](https://goreportcard.com/report/github.com/weblazy/builder)

Package builder is a lightweight and fast SQL builder for Go and XORM.

Make sure you have installed Go 1.8+ and then:

    go get github.com/weblazy/builder
...
```Go
import . "github.com/weblazy/builder"
